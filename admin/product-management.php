				...
				<div id="kt_header" class="header">
					...
					<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0"
							...
							<!--begin::Heading-->
							<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Gestion des produits et stocks
							</h1>
							<!--end::Heading-->
						</div>
						<!--end::Page title=-->
						...
						<div class="d-flex align-items-center flex-shrink-0">
							...
							<a href="#" class="btn btn-danger btn-hover-scale me-5 px-5">Ajouter un article</a>
							</div>
							<!--end::Activities-->
								...
								<div class="card card-flush h-xl-100">
									...
									<div class="card-header pt-7">
										...
										<h3 class="card-title align-items-start flex-column">
											<span class="fw-bolder text-gray-900 m-0">Meilleures vente</span>
														...
														<table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
															...
															<thead>
																<tr class="fs-7 fw-bolder text-gray-400 border-bottom-0">
																	...
																	<th class="p-0 pb-3 min-w-100px">Prix</th>
																	<th class="p-0 pb-3 min-w-100px">Stock</th>
																	<th class="p-0 pb-3 min-w-100px">Vendu</th>
																	<th class="p-0 pb-3 min-w-100px">Vu</th>
																	<th class="p-0 pb-3 min-w-80px">Status</th>
																	<th class="p-0 pb-3 w-80px text-end">Action</th>
																</tr>
															</thead>
															<!--end::Table head-->
															<!--begin::Table body-->
															<tbody>
																	...
																	<td>
																		<div class="d-flex align-items-center">
																			<div class="symbol symbol-50px me-3">
																				<img src="assets/media/stock/600x600/01.jpg" class="" alt="" />
																			</div>
																			<div class="d-flex justify-content-start flex-column">
																				<a href="#" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Souris gameur</a>
																				<span class="text-gray-400 fw-bold d-block fs-7">Informatique</span>
																			</div>
																		</div>
																	</td>
																	<td class="pe-0">
																		<span class="text-gray-600 fw-bolder fs-6">0.054 ETH</span>
																	</td>
																	<td class="pe-0">
																		<span class="text-gray-600 fw-bolder fs-6">34</span>
																	</td>
																	
																	<td class=" pe-0">
																		<span class="text-gray-600 fw-bolder fs-6">13</span>
																	</td>
																	<td class="pe-0">
																		<span class="text-gray-600 fw-bolder fs-6">784</span>
																	</td>
																	
																	<td class=" pe-0">
																		<label class="form-check form-switch form-check-custom form-check-solid">
																			<input class="form-check-input h-20px w-35px " checked="checked"  type="checkbox" value=""/>
																		</label>
																	</td>
																	<td class="text-end">
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			<div class="symbol symbol-50px me-3">
																				<img src="assets/media/stock/600x600/2.jpg" class="" alt="" />
																			</div>
																			<div class="d-flex justify-content-start flex-column">
																	...
																	<td class="text-end pe-0">
																		<span class="text-gray-600 fw-bolder fs-6">1.830 ETH</span>
																	</td>
																	<td class="text-end pe-0">
																		<span class="text-gray-600 fw-bolder fs-6">2.451 ETH</span>
																	</td>
																	
																	<td class="text-end pe-0">
																		<span class="text-gray-600 fw-bolder fs-6">4h 28m 07s</span>
																	</td>
																	<td class="text-end">
																		<a href="#" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
																			<!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			<div class="symbol symbol-50px me-3">
																				<img src="assets/media/stock/600x600/3.png" class="" alt="" />
																			</div>
																			<div class="d-flex justify-content-start flex-column">
																				<a href="#" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Color Face Art</a>
																				<span class="text-gray-400 fw-bold d-block fs-7">Wade Warren</span>
																			</div>
																		</div>
																	</td>
																	<td class="text-end pe-0">
																		<span class="text-gray-600 fw-bolder fs-6">0.043 ETH</span>
																	</td>
																	<td class="text-end pe-0">
																		<span class="text-gray-600 fw-bolder fs-6">0.124 ETH</span>
																	</td>
																	
																	<td class="text-end pe-0">
																		<span class="text-gray-600 fw-bolder fs-6">5h 09m 23s</span>
																	</td>
																	<td class="text-end">
																		<a href="#" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
																			<!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			<div class="symbol symbol-50px me-3">
																				<img src="assets/media/stock/600x600/4.png" class="" alt="" />
																			</div>
																			<div class="d-flex justify-content-start flex-column">
																	...
																	<td class="text-end pe-0">
																		<span class="text-gray-600 fw-bolder fs-6">0.092 ETH</span>
																	</td>
																	<td class="text-end pe-0">
																		<span class="text-gray-600 fw-bolder fs-6">0.158 ETH</span>
																	</td>
																	
																	<td class="text-end pe-0">
																		<span class="text-gray-600 fw-bolder fs-6">7h 23m 16s</span>
																	</td>
																	<td class="text-end">
																		<a href="#" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
																			<!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
																...
																<tr>
																	<td>
																		<div class="d-flex align-items-center">
																			<div class="symbol symbol-50px me-3">
																				<img src="assets/media/stock/600x600/5.png" class="" alt="" />
																			</div>
																			<div class="d-flex justify-content-start flex-column">
																				<a href="#" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6">Awesome Bird Art</a>
																				<span class="text-gray-400 fw-bold d-block fs-7">Jacob Jones</span>
																			</div>
																		</div>
																	</td>
																	<td class="text-end pe-0">
																	...
																	<td class="text-end pe-0">
																		<span class="text-gray-600 fw-bolder fs-6">1.072 ETH</span>
																	</td>
																	
																	<td class="text-end pe-0">
																		<span class="text-gray-600 fw-bolder fs-6">36h 18m 42s</span>
																	</td>
																	<td class="text-end">
																		<a href="#" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
																			<!--begin::Svg Icon | path: icons/duotune/arrows/arr001.svg-->
										...
										<div class="card-body pt-2">
											...
											<ul class="nav nav-pills nav-pills-custom mb-3">
												...
												<li class="nav-item mb-3 me-3 me-lg-6">
													<!--begin::Link-->
													<a class="nav-link d-flex justify-content-between flex-center overflow-hidden active h-70px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_1">
														<!--begin::Icon-->
														<div class="nav-icon">
												...
												<li class="nav-item mb-3 me-3 me-lg-6">
													<!--begin::Link-->
													<a class="nav-link d-flex justify-content-between flex-center overflow-hidden h-70px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_2">
														<!--begin::Icon-->
														<div class="nav-icon p-3">
												...
												<li class="nav-item mb-3 me-3 me-lg-6">
													<!--begin::Link-->
													<a class="nav-link d-flex justify-content-between flex-center overflow-hidden h-70px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_3">
														<!--begin::Icon-->
														<div class="nav-icon p-3">
												...
												<li class="nav-item mb-3 me-3 me-lg-6">
													<!--begin::Link-->
													<a class="nav-link d-flex justify-content-between  flex-center overflow-hidden h-70px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_4">
														<!--begin::Icon-->
														<div class="nav-icon p-3">
												...
												<li class="nav-item mb-3">
													<!--begin::Link-->
													<a class="nav-link d-flex justify-content-between  flex-center overflow-hidden  h-70px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_5">
														<!--begin::Icon-->
														<div class="nav-icon p-3">
														...
														<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
															...
															<tbody>
																<tr>
																	...
																	<td class="ps-0">
																		<a href="../../demo3/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
																...
																<tr>
																	...
																	<td class="ps-0">
																		<a href="../../demo3/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
																...
																<tr>
																	...
																	<td class="ps-0">
																		<a href="../../demo3/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
														...
														<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
															...
															<tbody>
																<tr>
																	...
																	<td class="ps-0">
																		<a href="../../demo3/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1324</a>
														...
														<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
															...
															<tbody>
																<tr>
																	...
																	<td class="ps-0">
																		<a href="../../demo3/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 2635</a>
																		<span class="text-gray-400 fw-bold fs-7 d-block text-start ps-0">Item: #XDG-1523</span>
																	</td>
																	<td>
																		<span class="text-gray-800 fw-bolder d-block fs-6 ps-0 text-end">x1</span>
														...
														<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
															...
															<tbody>
																<tr>
																	...
																	<td class="ps-0">
																		<a href="../../demo3/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Nike</a>
																...
																<tr>
																	...
																	<td class="ps-0">
																		<a href="../../demo3/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Adidas</a>
																...
																<tr>
																	...
																	<td class="ps-0">
																		<a href="../../demo3/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bolder text-hover-primary mb-1 fs-6 text-start pe-0">Puma</a>
