				...
				<div id="kt_header" class="header">
					...
					<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0"
							...
							<!--begin::Heading-->
							<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Gestion des commades
								<small class="text-muted fs-6 fw-bold ms-1 pt-3">Aperçu et traitement des commandes</small>
							</h1>
							<!--end::Heading-->
						</div>
						<!--end::Page title=-->
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					...
					<div class="container-xxl" id="kt_content_container">
						...
						<div class="gy-5 g-xl-10">
							<div class="mb-xl-10">
								<ul class="row  gy-5 g-xl-1 nav nav-tabs nav-line-tabs mb-5 fs-6">
									<li class="nav-item col-sm-4 col-xl-2 mb-xl-10">
										<a class="nav-link h-lg-100 active" data-bs-toggle="tab" href="#kt_tab_pane_1">
									
												<!--begin::Card widget 2-->
												<div class="card h-lg-100" style="background-color: #BFDDE3">
													<!--begin::Body-->
													<div class="card-body d-flex justify-content-between align-items-start flex-column">
														...
														<div class="d-flex flex-column my-7">
															...
															<div class="m-0">
																<span class="fw-bold fs-2 text-gray-600">En cours</span>
															</div>
															<!--end::Follower-->
														</div>
														<!--end::Section-->
									...
									<li class="nav-item col-sm-4 col-xl-2 mb-xl-10">
										<a class="nav-link h-lg-100" data-bs-toggle="tab" href="#kt_tab_pane_2">
											<div class="card h-lg-100" style="background-color: #F6E5CA;">
												<!--begin::Body-->
												<div class="card-body d-flex justify-content-between align-items-start flex-column">
													<!--begin::Icon-->
													<div class="m-0">
													...
													<div class="d-flex flex-column my-7">
														<div class="m-0">
															<span class="fw-bold fs-2 text-gray-600">Finalisées</span>
														</div>
														<!--end::Follower-->
													</div>
													<span class="badge badge-danger fs-base">
													
														<!--end::Svg Icon-->345 +</span>
												</div>
												<!--end::Body-->
											</div>
										</a>
									...
									<li class="nav-item col-sm-4 col-xl-2 mb-xl-10">
										<a class="nav-link h-lg-100" data-bs-toggle="tab" href="#kt_tab_pane_3">	<div class="card h-lg-100" style="background-color: #CBD4F4">
											<!--begin::Body-->
											<div class="card-body d-flex justify-content-between align-items-start flex-column">
												<!--begin::Icon-->
												<div class="m-0">
												...
												<div class="d-flex flex-column my-7">
													...
													<!--begin::Follower-->
													<div class="m-0">
														<span class="fw-bold fs-2 text-gray-600">Stock Value</span>
													</div>
													<!--end::Follower-->
												</div>
												<!--end::Section-->
												<!--begin::Badge-->
												<span class="badge badge-danger fs-base">0.47%</span>
												<!--end::Badge-->
											</div>
											<!--end::Body-->
										</div></a>
									...
									<li class="nav-item col-sm-4 col-xl-2 mb-xl-10">
										<a class="nav-link h-lg-100" data-bs-toggle="tab" href="#kt_tab_pane_4">	<div class="card h-lg-100" style="background-color:#b7e4c7b5;">
											<!--begin::Body-->
											<div class="card-body d-flex justify-content-between align-items-start flex-column">
												<!--begin::Icon-->
												<div class="m-0">
												...
												<div class="d-flex flex-column my-7">
													...
													<div class="m-0">
														<span class="fw-bold fs-2 text-gray-600">OPEX Lorem</span>
													</div>
													<!--end::Follower-->
												</div>
												<!--end::Section-->
												<!--begin::Badge-->
												<span class="badge badge-danger fs-base">78</span>
												<!--end::Badge-->
											</div>
											<!--end::Body-->
										</div></a>
									...
									<li class="nav-item col-sm-4 col-xl-2 mb-xl-10">
										<a class="nav-link h-lg-100" data-bs-toggle="tab" href="#kt_tab_pane_5">	<!--begin::Card widget 2-->
											<div class="card h-lg-100" style="background-color: #F3D6EF">
												<!--begin::Body-->
												<div class="card-body d-flex justify-content-between align-items-start flex-column">
													<!--begin::Icon-->
													<div class="m-0">
													...
													<div class="d-flex flex-column my-7">
														...
														<!--begin::Follower-->
														<div class="m-0">
															<span class="fw-bold fs-2 text-gray-600">C APEX</span>
														</div>
														<!--end::Follower-->
													</div>
													<!--end::Section-->
									...
									<li class="nav-item col-sm-4 col-xl-2 mb-xl-10">
										<a class="nav-link h-lg-100" data-bs-toggle="tab" href="#kt_tab_pane_6"><div class="card h-lg-100" style="background-color: #ffe5d9">
											<!--begin::Body-->
											<div class="card-body d-flex justify-content-between align-items-start flex-column">
												<!--begin::Icon-->
												<div class="m-0">
												...
												<div class="card card-flush h-xl-100">
													...
													<div class="card-header pt-7">
														...
														<h3 class="card-title align-items-start flex-column">
															<span class="card-label fw-bolder text-gray-800 my-2">Commandes en cours</span>
															<span class="text-gray-400 mt-1 fw-bold fs-6">Mise à jour il y'a 37 minutes</span>
														</h3>
														<!--end::Title-->
														<!--begin::Toolbar-->
														<div class="card-toolbar">
															<a href="../../demo3/dist/apps/ecommerce/catalog/add-product.html" class="btn btn-sm btn-light">History</a>
														</div>
														<!--end::Toolbar-->
													</div>
													<!--end::Header-->
