				...
				<div id="kt_header" class="header">
					...
					<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
						...
						<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0"
							...
							<!--begin::Heading-->
							<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Espaces utilisateurs
								<small class="text-muted fs-6 fw-bold ms-1 pt-1">listeet gestion 
									des utilisateurs</small>
							</h1>
							<!--end::Heading-->
						</div>
						<!--end::Page title=-->
								...
								<div id="kt_table_users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive"><table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_table_users">
									...
									<thead>
										...
										<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0"><th class="w-10px pe-2 sorting_disabled" rowspan="1" colspan="1" aria-label="
											...
											</th><th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1" aria-label="User: activate to sort column ascending" style="width: 277.117px;">Utilisateur</th><th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1" aria-label="Role: activate to sort column ascending" style="width: 153.906px;">Tél</th><th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1" aria-label="Last login: activate to sort column ascending" style="width: 153.906px;">Ville</th><th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1" aria-label="Two-step: activate to sort column ascending" style="width: 153.906px;">Inscrit le</th><th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1" aria-label="Joined Date: activate to sort column ascending" style="width: 204.836px;">Qty achat</th><th class="text-end min-w-100px sorting_disabled" rowspan="1" colspan="1" aria-label="Actions" style="width: 123.578px;">Actions</th></tr>
										<!--end::Table row-->
									</thead>
									<!--end::Table head-->
									<!--begin::Table body-->
									...
									<tr class="odd">
											...
											<td class="d-flex align-items-center">
												...
												<!--begin::User details-->
												<div class="d-flex flex-column">
													<a href="../../demo3/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
											...
											<!--end::Role=-->
											<!--begin::Last login=-->
											<td data-order="2022-05-31T12:14:31+00:00">
											...
											<!--end::Two step=-->
											<!--begin::Joined-->
											<td data-order="2022-09-22T18:05:00+00:00">22 Sep 2022, 6:05 pm</td>
											<!--begin::Joined-->
											<!--begin::Action=-->
											<td class="text-end">
												...
												<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
													...
													<div class="menu-item px-3">
														<a href="../../demo3/dist/apps/user-management/users/view.html" class="menu-link px-3">Edit</a>
													</div>
													<!--end::Menu item-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
											...
											<td class="d-flex align-items-center">
												...
												<!--begin::User details-->
												<div class="d-flex flex-column">
													<a href="../../demo3/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
											...
											<!--end::Role=-->
											<!--begin::Last login=-->
											<td data-order="2022-06-01T11:54:31+00:00">
											...
											<!--end::Two step=-->
											<!--begin::Joined-->
											<td data-order="2022-06-24T18:05:00+00:00">24 Jun 2022, 6:05 pm</td>
											<!--begin::Joined-->
											<!--begin::Action=-->
											<td class="text-end">
												<a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
											...
											<td class="d-flex align-items-center">
												...
												<!--begin::User details-->
												<div class="d-flex flex-column">
													<a href="../../demo3/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">Max Smith</a>
											...
											<!--end::Role=-->
											<!--begin::Last login=-->
											<td data-order="2022-05-29T12:14:31+00:00">
											...
											<!--end::Two step=-->
											<!--begin::Joined-->
											<td data-order="2022-05-05T10:30:00+00:00">05 May 2022, 10:30 am</td>
											<!--begin::Joined-->
											<!--begin::Action=-->
											<td class="text-end">
												<a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
											...
											<td class="d-flex align-items-center">
												...
												<!--begin::User details-->
												<div class="d-flex flex-column">
													<a href="../../demo3/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
											...
											<!--end::Role=-->
											<!--begin::Last login=-->
											<td data-order="2022-06-01T07:14:31+00:00">
											...
											<!--end::Two step=-->
											<!--begin::Joined-->
											<td data-order="2022-03-10T20:43:00+00:00">10 Mar 2022, 8:43 pm</td>
											<!--begin::Joined-->
											<!--begin::Action=-->
											<td class="text-end">
												<a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
											...
											<td class="d-flex align-items-center">
												...
												<!--begin::User details-->
												<div class="d-flex flex-column">
													<a href="../../demo3/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
											...
											<!--end::Role=-->
											<!--begin::Last login=-->
											<td data-order="2022-05-30T12:14:31+00:00">
											...
											<!--end::Two step=-->
											<!--begin::Joined-->
											<td data-order="2022-11-10T17:20:00+00:00">10 Nov 2022, 5:20 pm</td>
											<!--begin::Joined-->
											<!--begin::Action=-->
											<td class="text-end">
												<a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
											...
											<td class="d-flex align-items-center">
												...
												<!--begin::User details-->
												<div class="d-flex flex-column">
													<a href="../../demo3/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
											...
											<!--end::Role=-->
											<!--begin::Last login=-->
											<td data-order="2022-05-27T12:14:31+00:00">
											...
											<!--end::Two step=-->
											<!--begin::Joined-->
											<td data-order="2022-02-21T17:30:00+00:00">21 Feb 2022, 5:30 pm</td>
											<!--begin::Joined-->
											<!--begin::Action=-->
											<td class="text-end">
												<a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
											...
											<td class="d-flex align-items-center">
												...
												<!--begin::User details-->
												<div class="d-flex flex-column">
													<a href="../../demo3/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
											...
											<!--end::Role=-->
											<!--begin::Last login=-->
											<td data-order="2022-05-11T12:14:31+00:00">
											...
											<!--end::Two step=-->
											<!--begin::Joined-->
											<td data-order="2022-10-25T10:30:00+00:00">25 Oct 2022, 10:30 am</td>
											<!--begin::Joined-->
											<!--begin::Action=-->
											<td class="text-end">
												<a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
											...
											<td class="d-flex align-items-center">
												...
												<!--begin::User details-->
												<div class="d-flex flex-column">
													<a href="../../demo3/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
											...
											<td class="d-flex align-items-center">
												...
												<!--begin::User details-->
												<div class="d-flex flex-column">
													<a href="../../demo3/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
											...
											<!--end::Two step=-->
											<!--begin::Joined-->
											<td data-order="2022-10-25T21:23:00+00:00">25 Oct 2022, 9:23 pm</td>
											<!--begin::Joined-->
											<!--begin::Action=-->
											<td class="text-end">
												<a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
											...
											<td class="d-flex align-items-center">
												...
												<!--begin::User details-->
												<div class="d-flex flex-column">
													<a href="../../demo3/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
											...
											<!--end::Two step=-->
											<!--begin::Joined-->
											<td data-order="2022-05-05T14:40:00+00:00">05 May 2022, 2:40 pm</td>
											<!--begin::Joined-->
											<!--begin::Action=-->
											<td class="text-end">
												<a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
						...
						<div id="kt_sidebar_content">
							<div class="hover-scroll-y" data-kt-scroll="true" data-kt-scroll-height="auto"
								...
								<div class="tab-content px-5 px-xxl-10">
										...
										<div class="card card-flush card-p-0 shadow-none bg-transparent mb-5">
											...
											<div class="card-header align-items-center border-0">
												...
												<div class="card-toolbar">
													...
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
														data-kt-menu="true" id="kt_menu_624457bd76d00">
														<!--begin::Header-->
														<div class="px-7 py-5">
															...
															<div class="mb-10">
																...
																<div>
																	<select class="form-select form-select-solid"
																		...
																		data-dropdown-parent="#kt_menu_624457bd76d00"
											...
											<div class="card-body py-0">
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													...
													<div class="d-flex flex-column">
														<a href="#"
															class="text-white text-hover-primary fs-6 fw-bolder">Project
															Briefing</a>
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													...
													<div class="d-flex flex-column">
														<a href="#"
															class="text-white text-hover-primary fs-6 fw-bolder">Concept
															Design</a>
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													...
													<div class="d-flex flex-column">
														<a href="#"
															class="text-white text-hover-primary fs-6 fw-bolder">Functional
															Logics</a>
												...
												<div class="d-flex flex-nowrap align-items-center">
													...
													<div class="d-flex flex-column">
														<a href="#"
															class="text-white text-hover-primary fs-6 fw-bolder">Testing</a>
									...
									<!--end::Tab pane-->
									<!--begin::Tab pane-->
									<div class="tab-pane fade" id="kt_sidebar_tab_2" role="tabpanel">n,
										<!--begin::Statistics Widget-->
										<div class="card card-flush card-p-0 shadow-none bg-transparent mb-10">
											<!--begin::Header-->
											<div class="card-header align-items-center border-0">
											...
											<div class="card-body py-0">
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													...
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#"
															class="text-white fw-bold text-hover-primary fs-6">Premium
															Coffee</a>
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													...
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#" class="text-white fw-bold text-hover-primary fs-6">Light
															Sneakers</a>
														<span class="sidebar-text-muted fw-bold fs-7 my-1">The Best
															Lightweight Sneakers</span>
													</div>
													<!--end::Title-->
												</div>
												<!--end::Item-->
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													...
													<!--begin::Title-->
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#" class="text-white fw-bold text-hover-primary fs-6">Red
															Boots</a>
														<span class="sidebar-text-muted fw-bold fs-7 my-1">All Season
															Boots</span>
													</div>
													<!--end::Title-->
												</div>
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													...
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#" class="text-white fw-bold text-hover-primary fs-6">Wall
															Decoration</a>
														<span class="sidebar-text-muted fw-bold fs-7 my-1">Creative &amp;
												...
												<div class="d-flex flex-nowrap align-items-center">
													...
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#" class="text-white fw-bold text-hover-primary fs-6">Home
															Confort</a>
														<span class="sidebar-text-muted fw-bold fs-7 my-1">Smart Air
															Purifier</span>
													</div>
													<!--end::Title-->
												</div>
									...
									<div class="tab-pane fade show active" id="kt_sidebar_tab_3" role="tabpanel">
										...
										<div class="card card-flush card-p-0 shadow-none bg-transparent mb-5">
											...
											<div class="card-header align-items-center">
												<!--begin::Title-->
												<h3 class="card-title fw-bolder text-white fs-3">Raccourcies</h3>
												<!--end::Title-->
												<!--begin::Toolbar-->
												<div class="card-toolbar">
													<button type="button"
											...
											<div class="card-body">
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													...
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#"
															class="text-white fw-bold text-hover-primary fs-6">Spotify
															App</a>
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													...
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#"
															class="text-white fw-bold text-hover-primary fs-6">Fitnes
															Drive</a>
														<span class="sidebar-text-muted fw-bold fs-7 my-1">Angular,
															Typescript, Bootstrap</span>
													</div>
													<!--end::Title-->
												</div>
												<!--end::Item-->
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													...
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#"
															class="text-white fw-bold text-hover-primary fs-6">Taskify
															App</a>
														<span class="sidebar-text-muted fw-bold fs-7 my-1">HTML, CSS.
															jQuery</span>
													</div>
													<!--end::Title-->
												</div>
												...
												<div class="d-flex flex-nowrap align-items-center mb-7">
													...
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#"
															class="text-white fw-bold text-hover-primary fs-6">Calendr
															App</a>
												...
												<div class="d-flex flex-nowrap align-items-center">
													...
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
														<a href="#"
															class="text-white fw-bold text-hover-primary fs-6">Stocked
															SaaS</a>
										...
										<div class="card card-flush card-p-0 shadow-none bg-transparent mb-5">
											...
											<div class="card-header align-items-center border-0">
												...
												<div class="card-toolbar">
													...
													<!--begin::Menu 1-->
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
														data-kt-menu="true" id="kt_menu_624457bd791d4">
														<!--begin::Header-->
														<div class="px-7 py-5">
															<div class="fs-5 text-dark fw-bolder">Filter Options</div>
														</div>
															...
															<div class="mb-10">
																...
																<div>
																	<select class="form-select form-select-solid"
																		data-kt-select2="true"
																		data-placeholder="Select option"
																		data-dropdown-parent="#kt_menu_624457bd791d4"
																		data-allow-clear="true">
																		<option></option>
																		<option value="1">Approved</option>
																		<option value="2">Pending</option>
									...
									<div class="tab-pane fade" id="kt_sidebar_tab_5" role="tabpanel">
										...
										<div class="card card-flush card-p-0 shadow-none bg-transparent mb-5">
											...
											<div class="card-header align-items-center border-0">
												<!--begin::Title-->
												<h3 class="card-title fw-bolder text-white fs-3"></h3>
												<!--end::Title-->
												<!--begin::Toolbar-->
												<div class="card-toolbar">
													<button type="button"
													...
													<!--begin::Menu 1-->
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
														data-kt-menu="true" id="kt_menu_624457bd79cb8">
														<!--begin::Header-->
														<div class="px-7 py-5">
															<div class="fs-5 text-dark fw-bolder">Filter Options</div>
														</div>
															...
															<div class="mb-10">
																...
																<div>
																	<select class="form-select form-select-solid"
																		data-kt-select2="true"
																		data-placeholder="Select option"
																		data-dropdown-parent="#kt_menu_624457bd79cb8"
																		data-allow-clear="true">
																		<option></option>
																		<option value="1">Approved</option>
																		<option value="2">Pending</option>
