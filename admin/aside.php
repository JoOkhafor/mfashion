<div id="kt_sidebar" class="sidebar" data-kt-drawer="true" data-kt-drawer-name="sidebar"
				...
				<div class="d-flex flex-column sidebar-body px-5 py-10" id="kt_sidebar_body">
					<!--begin::Sidebar Nav-->
								...
								<div class="tab-pane fade show active" id="kt_sidebar_tab_3" role="tabpanel">
										...
										<div class="card card-flush card-p-0 shadow-none bg-transparent mb-10">
											...
											<div class="card-header align-items-center border-0">
												<!--begin::Title-->
												<h3 class="card-title fw-bolder text-white fs-3">État de vos activités</h3>
												<!--end::Title-->
												...
												<div class="row g-5">
													...
													<div class="col-6">
														...
														<div
															...
															<!--begin::Value-->
															<!--begin::Label-->
															<div class="sidebar-text-muted fs-6 fw-bold">Commandes en cours</div>
															<!--end::Label-->
													...
													<div class="col-6">
														...
														<div
															...
															<!--begin::Value-->
															<!--begin::Label-->
															<div class="sidebar-text-muted fs-6 fw-bold">Commandes livréss</div>
															<!--end::Label-->
														</div>
														<!--end::Item-->
													</div>
													...
													<div class="col-6">
														...
														<div
															...
															<!--begin::Value-->
															<!--begin::Label-->
															<div class="sidebar-text-muted fs-6 fw-bold">Utilisateurs</div>
															<!--end::Label-->
														</div>
														<!--end::Item-->
													</div>
													...
													<div class="col-6">
														...
														<div
															...
															<!--begin::Value-->
															<!--begin::Label-->
															<div class="sidebar-text-muted fs-6 fw-bold">Trafic</div>
															<!--end::Label-->
														</div>
														<!--end::Item-->
													</div>
						...
						<!--end::Sidebar Content-->
							<div class="sidebar-nav nav-tabs menu-item px-5" id="kt_sidebar_tabs">
									<div class="menu-content px-5">
										<div class="menu-item">
											<a href="#" class="btn d-block w-100 btn-primary">Se déconnecter</a>
										</div>
									</div>
								</div> 
